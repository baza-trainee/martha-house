...
const languages = {
    [Locale.en]: () => import('../assets/en_US.json').then(module => module.default),
    [Locale.ua]: () => import('../assets/uk_UA.json').then(module => module.default),
    [Locale.pl]: () => import('../assets/pl_PL.json').then(module => module.default),
};
